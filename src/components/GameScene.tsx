  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        {/* === SPRITE LAYER — always behind UI, anchored to bottom === */}
        {sprites && (
          <div className="absolute inset-0 z-10 pointer-events-none overflow-hidden">
            {sprites.left && (
              <motion.div
                key={`sprite-left-${title}`}
                className="absolute bottom-0 left-1/2 -translate-x-1/2 md:left-[5%] md:translate-x-0"
              ...
              >
                <img
                  src={sprites.left}
                  alt="Character"
                  className="h-[60vh] md:h-[65vh] w-auto object-contain object-bottom"
                />
              </motion.div>
            )}
            {sprites.right && (
        ...
        {/* === UI LAYER — on top of sprite === */}
        <div className="relative z-20 h-full flex flex-col">
          {/* Top: Title + Text */}
          <div className="flex-shrink-0 px-4 pt-5 pb-2 md:pt-8">
            <motion.div
          ...
          {/* Choice Buttons — on mobile placed right after text; on desktop at bottom */}
          <div className="flex-shrink-0 px-4 pt-2 pb-4 md:mt-auto md:pb-8">
            <motion.div
          ...
          {/* Spacer — pushes nothing on mobile, fills space on desktop */}

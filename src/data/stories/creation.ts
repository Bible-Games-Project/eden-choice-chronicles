...
export const creationScenes: Record<string, StoryScene> = {
  start: {
    ...
    choices: [
      ...
      { text: "Create the heavens and the earth", nextScene: "void", tag: "aware", feedback: "Genesis 1:1: 'In the beginning God created the heavens and the earth.'", isCorrect: true, sentiment: "positive" },
  ...
  silence: {
    ...
    choices: [
      { text: "Say: 'Let there be light'", nextScene: "light", tag: "drawn", feedback: "Genesis 1:3: 'And God said, Let there be light.'", isCorrect: true, sentiment: "positive" },
  ...
  voice: {
    ...
    choices: [
      { text: "'Let there be light'", nextScene: "light_obey", tag: "obedient", feedback: "light was the first thing God spoke into being (Genesis 1:3).", isCorrect: true, sentiment: "positive" },
  ...
  void: {
    ...
    choices: [
      { text: "Say: 'Let there be light'", nextScene: "light", tag: "witness", feedback: "Genesis 1:3: 'Let there be light.'", isCorrect: true, sentiment: "positive" },
  ...
  light: {
    ...
    choices: [
      ...
      { text: "Separate the light from the darkness", nextScene: "day_night", tag: "understanding", feedback: "Genesis 1:4: 'And God separated the light from the darkness.'", isCorrect: true, sentiment: "positive" },
    ],
  },
  light_obey: {
    id: "light_obey",
    ...
    choices: [
      { text: "Call the light Day and the darkness Night", nextScene: "warmth", tag: "grateful", feedback: "Genesis 1:5: 'God called the light Day, and the darkness he called Night.'", isCorrect: true, sentiment: "positive" },
  ...
  light_awe: {
    ...
    choices: [
      ...
      { text: "Call the light Day and the darkness Night", nextScene: "day_night", tag: "moved", feedback: "Genesis 1:5: God called the light Day and the darkness Night.", isCorrect: true, sentiment: "positive" },
    ],
  },
  warmth: {
    id: "warmth",
    ...
    choices: [
      { text: "An expanse to separate the waters above from below", nextScene: "sky", tag: "curious", feedback: "Genesis 1:6-7: God made an expanse and separated the waters above from the waters below.", isCorrect: true, sentiment: "positive" },
  ...
  day_night: {
    ...
    choices: [
      { text: "Create the expanse and call it Heaven", nextScene: "sky", tag: "patient", feedback: "Genesis 1:8: 'And God called the expanse Heaven.'", isCorrect: true, sentiment: "positive" },
  ...
  sky: {
    ...
    choices: [
      ...
      { text: "Gather the waters together into one place", nextScene: "waters_gather", tag: "peaceful", feedback: "Genesis 1:9: 'Let the waters be gathered into one place, and let the dry land appear.'", isCorrect: true, sentiment: "positive" },
  ...
  sky_vast: {
    ...
    choices: [
      ...
      { text: "Gather the waters into seas so dry land appears", nextScene: "waters_gather", tag: "anticipating", feedback: "Genesis 1:9-10: God gathered the waters into seas and dry land appeared.", isCorrect: true, sentiment: "positive" },
    ],
  },
  waters_gather: {
    id: "waters_gather",
    ...
    choices: [
      { text: "Cover the land with plants, seeds, and fruit trees", nextScene: "land", tag: "explorer", feedback: "Genesis 1:11: 'Let the earth sprout vegetation, plants yielding seed, and fruit trees.'", isCorrect: true, sentiment: "positive" },
  ...
  expanse: {
    ...
    choices: [
      { text: "Bring forth dry land, plants, and fruit trees", nextScene: "land", tag: "grounded", feedback: "Genesis 1:9-12: dry land, seas, and vegetation appear on Day Three.", isCorrect: true, sentiment: "positive" },
  ...
  land: {
    ...
    choices: [
      { text: "Plants, herbs, and fruit trees — each according to its kind", nextScene: "plants", tag: "wanderer", feedback: "Genesis 1:11-12: plants and trees each 'according to its kind.'", isCorrect: true, sentiment: "positive" },
  ...
  land_emerge: {
    ...
    choices: [
      { text: "Vegetation with seed, and fruit trees bearing fruit", nextScene: "plants", tag: "wanderer", feedback: "Genesis 1:11: 'plants yielding seed, and fruit trees bearing fruit... each according to its kind.'", isCorrect: true, sentiment: "positive" },
  ...
  plants: {
    ...
    choices: [
      { text: "Lights in the expanse — sun, moon, and stars", nextScene: "stars", tag: "patient", feedback: "Genesis 1:14-16: God made the sun, moon, and stars on Day Four.", isCorrect: true, sentiment: "positive" },
  ...
  flowers: {
    ...
    choices: [
      ...
      { text: "The sun, moon, and stars", nextScene: "stars", tag: "dreamer", feedback: "Genesis 1:14-19: God set the sun, moon, and stars in the expanse of the heavens.", isCorrect: true, sentiment: "positive" },
    ],
  },
  mountain: {
    id: "mountain",
    ...
    choices: [
      { text: "Sun, moon, and stars in the heavens", nextScene: "stars_vision", tag: "visionary", feedback: "Genesis 1:14-19: God set two great lights and the stars in the expanse of the heavens.", isCorrect: true, sentiment: "positive" },
  ...
  stars: {
    ...
    choices: [
      ...
      { text: "A greater light to rule the day, a lesser to rule the night, and the stars", nextScene: "moonrise", tag: "contemplative", feedback: "Genesis 1:16: 'The greater light to rule the day, and the lesser light to rule the night — and the stars.'", isCorrect: true, sentiment: "positive" },
    ],
  },
  stars_delight: {
    id: "stars_delight",
    ...
    choices: [
      { text: "The sun, the moon, and countless stars", nextScene: "countless_stars", tag: "awed", feedback: "Genesis 1:14-16: sun, moon, and stars — for signs and seasons, days and years.", isCorrect: true, sentiment: "positive" },
  ...
  stars_vision: {
    ...
    choices: [
      { text: "Countless — beyond number", nextScene: "countless_stars", tag: "longing", feedback: "Genesis 15:5 and 22:17 describe the stars of heaven as too many to count.", isCorrect: true, sentiment: "positive" },
  ...
  countless_stars: {
    ...
    choices: [
      { text: "Creatures that swarm the waters, and birds to fly above", nextScene: "sea_creatures", tag: "moved", feedback: "Genesis 1:20-21: 'Let the waters swarm with living creatures, and let birds fly above the earth.'", isCorrect: true, sentiment: "positive" },
  ...
  moonrise: {
    ...
    choices: [
      { text: "Sea creatures and flying birds", nextScene: "sea_creatures", tag: "alert", feedback: "Genesis 1:20-23: sea creatures and birds fill the waters and skies on Day Five.", isCorrect: true, sentiment: "positive" },
  ...
  sea_dawn: {
    ...
    choices: [
      { text: "Great sea creatures, fish, and every winged bird", nextScene: "sea_creatures", tag: "eager", feedback: "Genesis 1:20-22: God created the great sea creatures and every winged bird, and blessed them.", isCorrect: true, sentiment: "positive" },
  ...
  sea_creatures: {
    ...
    choices: [
      { text: "'Be fruitful and multiply, and fill the waters and the earth'", nextScene: "land_creatures", tag: "eager", feedback: "Genesis 1:22: 'Be fruitful and multiply and fill the waters in the seas, and let birds multiply on the earth.'", isCorrect: true, sentiment: "positive" },
  ...
  bird_flight: {
    ...
    choices: [
      { text: "Livestock, wild beasts, and creeping things of the earth", nextScene: "land_creatures", tag: "grounded", feedback: "Genesis 1:24-25: cattle, beasts of the earth, and creeping things on Day Six.", isCorrect: true, sentiment: "positive" },
  ...
  land_creatures: {
    ...
    choices: [
      { text: "Say: 'Let us make man in our image, after our likeness'", nextScene: "before_man", tag: "anticipating", feedback: "Genesis 1:26: 'Let us make man in our image, after our likeness.'", isCorrect: true, sentiment: "positive" },
  ...
  land_creatures_wind: {
    ...
    choices: [
      ...
      { text: "A being made in the image of God", nextScene: "before_man", tag: "lonely", feedback: "Genesis 1:26-27: humans are made in the image and likeness of God.", isCorrect: true, sentiment: "positive" },
    ],
  },
  among_animals: {
    id: "among_animals",
    ...
    choices: [
      ...
      { text: "Form him from the dust of the ground", nextScene: "before_man", tag: "trusting", feedback: "Genesis 2:7: 'The Lord God formed the man of dust from the ground.'", isCorrect: true, sentiment: "positive" },
    ],
  },
  before_man: {
    id: "before_man",
    ...
    choices: [
      ...
      { text: "Breathe the breath of life into his nostrils", nextScene: "breath_of_life_sacred", tag: "sacred", feedback: "Genesis 2:7: 'He breathed into his nostrils the breath of life, and the man became a living creature.'", isCorrect: true, sentiment: "positive" },
    ],
  },
  before_man_lonely: {
    ...
    choices: [
      { text: "Your breath in his nostrils", nextScene: "breath_of_life_sacred", tag: "participant", feedback: "Genesis 2:7: God breathed the breath of life into the man's nostrils, and he became a living being.", isCorrect: true, sentiment: "positive" },
  ...
  breath_of_life: {
    ...
    choices: [
      ...
      { text: "In the garden of Eden, to work it and keep it", nextScene: "first_garden_wonder", tag: "awakened", feedback: "Genesis 2:15: 'The Lord God took the man and put him in the garden of Eden to work it and keep it.'", isCorrect: true, sentiment: "positive" },
    ],
  },
  breath_of_life_sacred: {
    ...
    choices: [
      { text: "A garden in Eden, with every tree pleasant to the sight and good for food", nextScene: "first_garden_wonder", tag: "newborn", feedback: "Genesis 2:8-9: God planted a garden in Eden with every tree pleasant to sight and good for food.", isCorrect: true, sentiment: "positive" },
  ...
  first_garden: {
    ...
    choices: [
      { text: "'Behold, it was very good'", nextScene: "very_good", tag: "complete", feedback: "Genesis 1:31: 'God saw everything that he had made, and behold, it was very good.'", isCorrect: true, sentiment: "positive" },
  ...
  first_garden_wonder: {
    ...
    choices: [
      { text: "'Behold, it is very good'", nextScene: "very_good", tag: "grateful", feedback: "Genesis 1:31: 'And God saw everything that he had made, and behold, it was very good.'", isCorrect: true, sentiment: "positive" },
  ...
  very_good: {
    ...
    choices: [
      { text: "Rest, and bless the seventh day, making it holy", nextScene: "rest", tag: "blessed", feedback: "Genesis 2:2-3: 'On the seventh day God finished his work... He blessed the seventh day and made it holy.'", isCorrect: true, sentiment: "positive" },
    ],
  },
  rest: {
    id: "rest",

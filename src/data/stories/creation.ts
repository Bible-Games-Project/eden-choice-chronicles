...
// Audio configuration per scene
export const creationAudio: Record<string, {
  chordNotes: number[];
  droneNotes?: number[];
  droneVolume?: number;
  wind?: boolean;
  ...
  start: { chordNotes: [130.81, 196.00, 261.63], droneNotes: [65.41], droneVolume: 0.1, wind: true, windIntensity: 0.6 },
  silence: { chordNotes: [130.81, 164.81, 196.00], droneNotes: [65.41], droneVolume: 0.08 },
  voice: { chordNotes: [196.00, 246.94, 329.63], droneNotes: [98.00, 196.00], droneVolume: 0.12, wind: true, windIntensity: 0.4 },
  void: { chordNotes: [130.81, 164.81, 220.00], droneNotes: [65.41], droneVolume: 0.1, water: true, waterIntensity: 0.3 },
  light: { chordNotes: [261.63, 329.63, 392.00, 523.25], droneNotes: [130.81], droneVolume: 0.06, wind: true, windIntensity: 0.15 },
  warmth: { chordNotes: [293.66, 349.23, 440.00], droneNotes: [146.83], droneVolume: 0.05, wind: true, windIntensity: 0.1 },
  day_night: { chordNotes: [220.00, 261.63, 329.63], droneNotes: [110.00], droneVolume: 0.06, wind: true, windIntensity: 0.2 },
  sky: { chordNotes: [349.23, 440.00, 523.25], droneNotes: [174.61], droneVolume: 0.05, wind: true, windIntensity: 0.25 },
  waters_gather: { chordNotes: [196.00, 246.94, 329.63], water: true, waterIntensity: 0.7, wind: true, windIntensity: 0.15 },
  expanse: { chordNotes: [261.63, 329.63, 392.00], droneNotes: [130.81, 196.00], droneVolume: 0.07, wind: true, windIntensity: 0.3 },
  land: { chordNotes: [293.66, 349.23, 440.00], droneNotes: [146.83], wind: true, windIntensity: 0.2 },
  plants: { chordNotes: [261.63, 329.63, 392.00], droneNotes: [130.81], birds: true, wind: true, windIntensity: 0.15 },
  flowers: { chordNotes: [349.23, 440.00, 523.25], droneNotes: [174.61], birds: true, wind: true, windIntensity: 0.1 },
  mountain: { chordNotes: [220.00, 329.63, 440.00], droneNotes: [110.00], wind: true, windIntensity: 0.5 },
  stars: { chordNotes: [261.63, 329.63, 392.00, 523.25], droneNotes: [130.81, 196.00], droneVolume: 0.08, wind: true, windIntensity: 0.08 },
  countless_stars: { chordNotes: [220.00, 329.63, 440.00], droneNotes: [110.00, 220.00], droneVolume: 0.09 },
  moonrise: { chordNotes: [174.61, 261.63, 349.23], droneNotes: [87.31], droneVolume: 0.07, wind: true, windIntensity: 0.1 },
  sea_creatures: { chordNotes: [196.00, 293.66, 392.00], water: true, waterIntensity: 0.5, birds: true, wind: true, windIntensity: 0.2 },
  bird_flight: { chordNotes: [329.63, 440.00, 523.25], droneNotes: [164.81], birds: true, wind: true, windIntensity: 0.35 },
  land_creatures: { chordNotes: [261.63, 329.63, 392.00], droneNotes: [130.81], birds: true, wind: true, windIntensity: 0.2 },
  among_animals: { chordNotes: [293.66, 349.23, 440.00], droneNotes: [146.83], birds: true, wind: true, windIntensity: 0.15 },
  before_man: { chordNotes: [220.00, 261.63, 329.63], droneNotes: [110.00, 220.00], droneVolume: 0.1, wind: true, windIntensity: 0.1 },
  breath_of_life: { chordNotes: [261.63, 329.63, 392.00, 523.25], droneNotes: [130.81, 196.00], droneVolume: 0.08 },
  first_garden: { chordNotes: [349.23, 440.00, 523.25], droneNotes: [174.61], birds: true, wind: true, windIntensity: 0.15 },
  very_good: { chordNotes: [261.63, 329.63, 392.00, 523.25], droneNotes: [130.81, 196.00], droneVolume: 0.07, birds: true, wind: true, windIntensity: 0.1 },
  rest: { chordNotes: [261.63, 329.63, 392.00], droneNotes: [130.81], droneVolume: 0.05, birds: true, wind: true, windIntensity: 0.08 },
};

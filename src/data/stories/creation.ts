...
export const creationScenes: Record<string, StoryScene> = {
  ...
  silence: {
    ...
    choices: [
      { text: "Let the first word form", nextScene: "light", tag: "drawn", feedback: "The word gathers inside you — heavy with purpose.", sentiment: "positive" },
      { text: "Breathe over the waters", nextScene: "light_awe", tag: "awestruck", feedback: "Your breath ripples across the deep. Something awakens.", sentiment: "positive" },
    ],
  },
  voice: {
    id: "voice",
  ...
  warmth: {
    ...
    choices: [
      { text: "Stretch the sky open above", nextScene: "sky", tag: "curious", feedback: "You reach upward. The sky begins to unfold.", sentiment: "positive" },
      { text: "Spread your hands — expand it all", nextScene: "sky_vast", tag: "amazed", feedback: "Everything stretches — wider, higher, limitless.", sentiment: "positive" },
    ],
  },
  day_night: {
    id: "day_night",
  ...
  sky_vast: {
    ...
    choices: [
      { text: "Call forth the land below", nextScene: "land", tag: "grounded", feedback: "You speak downward. The ground trembles in answer.", sentiment: "positive" },
      { text: "Gather the seas into their places", nextScene: "waters_gather", tag: "anticipating", feedback: "The waters rush to their boundaries — eager, wild.", sentiment: "positive" },
    ],
  },
  waters_gather: {
    id: "waters_gather",
  ...
  among_animals: {
    ...
    choices: [
      { text: "Feel the ache of being alone", nextScene: "before_man_lonely", tag: "lonely", feedback: "The loneliness deepens. You need someone who understands.", sentiment: "negative" },
      { text: "Begin the final work", nextScene: "before_man", tag: "trusting", feedback: "You stand. Your hands know what to do.", sentiment: "positive" },
    ],
  },
  before_man: {
    id: "before_man",
  ...
  breath_of_life: {
    ...
    choices: [
      { text: "Watch his eyes open", nextScene: "first_garden", tag: "born", feedback: "His eyes open. He sees you first.", sentiment: "positive" },
      { text: "Place him gently in the garden", nextScene: "first_garden_wonder", tag: "awakened", feedback: "You carry him — warm, breathing — into paradise.", sentiment: "positive" },
    ],
  },
  breath_of_life_sacred: {
    ...
    choices: [
      { text: "Set him down in paradise", nextScene: "first_garden_wonder", tag: "newborn", feedback: "You lay him gently on the grass. He stirs.", sentiment: "positive" },
      { text: "Stand back — let him see the world", nextScene: "first_garden", tag: "alive", feedback: "You step away. His eyes open to everything you made.", sentiment: "positive" },
    ],
  },
  first_garden: {
    id: "first_garden",
  ...
  first_garden_wonder: {
    ...
    choices: [
      { text: "Speak the final words", nextScene: "very_good", tag: "grateful", feedback: "Your voice fills the garden — warm, full, complete.", sentiment: "positive" },
      { text: "Rest — your work is finished", nextScene: "rest_blessed", tag: "beloved", feedback: "You exhale. It is done.", sentiment: "positive" },
    ],
  },
  very_good: {
    id: "very_good",
    ...
    choices: [
      { text: "Rest — you have finished", nextScene: "rest", tag: "blessed", feedback: "Peace settles over everything.", sentiment: "positive" },
    ],
  },
  rest: {
    id: "rest",

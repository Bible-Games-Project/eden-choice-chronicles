...
export const wiseMenScenes: Record<string, StoryScene> = {
  ...
  start: {
    ...
    choices: [
      ...
      { text: "Search the ancient prophecies", nextScene: "journey", tag: "wise", feedback: "Matthew 2:2 — The wise men came to Jerusalem asking where the one who has been born king of the Jews was, for they had seen his star in the east and had come to worship him.", isCorrect: true, sentiment: "positive" },
  ...
  journey: {
    ...
    choices: [
      ...
      { text: "Press on toward Jerusalem", nextScene: "herod", tag: "faithful", feedback: "Matthew 2:9 — After they had heard the king, they went on their way, and the star they had seen in the east went ahead of them until it stopped over the place where the child was.", isCorrect: true, sentiment: "positive" },
  ...
  herod: {
    ...
    choices: [
      ...
      { text: "Listen to the priests' answer", nextScene: "bethlehem", tag: "wise", feedback: "Matthew 2:4-6 — Herod called together all the people’s chief priests and teachers of the law, and he asked them where the Messiah was to be born. They told him, “In Bethlehem in Judea, for this is what the prophet has written: ‘But you, Bethlehem, in the land of Judah, are by no means least among the rulers of Judah; for out of you will come a ruler who will shepherd my people Israel.’”", isCorrect: true, sentiment: "positive" },
    ],
  },
  loyalty_consequence: {
  ...
  bethlehem: {
    ...
    choices: [
      ...
      { text: "Knock and enter with reverence", nextScene: "worship", tag: "faithful", feedback: "Matthew 2:11 — On coming to the house, they saw the child with his mother Mary, and they bowed down and worshiped him.", isCorrect: true, sentiment: "positive" },
  ...
  worship: {
    ...
    choices: [
      ...
      { text: "Offer all three gifts to the child", nextScene: "dream", tag: "faithful", feedback: "Matthew 2:11 — Then they opened their treasures and presented him with gifts of gold, frankincense and myrrh.", isCorrect: true, sentiment: "positive" },
    ],
  },
  greed_consequence: {
  ...
  dream: {
    ...
    choices: [
      ...
      { text: "Take another road home", nextScene: "return", tag: "faithful", feedback: "Matthew 2:12 — And having been warned in a dream not to go back to Herod, they returned to their country by another route.", isCorrect: true, sentiment: "positive" },

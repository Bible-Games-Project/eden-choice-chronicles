...
export const birthMosesScenes: Record<string, StoryScene> = {
  ...
  hand_consequence: {
    ...
    choices: [
      { text: "Hide him in your home", nextScene: "hide_home", tag: "brave", feedback: "You bolt the door.", isCorrect: true, sentiment: "positive" },
    ],
  },
  flee_consequence: {
    id: "flee_consequence",
    ...
    choices: [
      { text: "Hide him in your home", nextScene: "hide_home", tag: "brave", feedback: "You return to the cradle.", isCorrect: true, sentiment: "positive" },
    ],
  },
  hide_home: {
    id: "hide_home",
  ...
  show_consequence: {
    ...
    choices: [
      { text: "Keep hiding him in silence", nextScene: "growing_baby", tag: "faithful", feedback: "You return to the shadows.", isCorrect: true, sentiment: "positive" },
    ],
  },
  growing_baby: {
    id: "growing_baby",
  ...
  bury_consequence: {
    ...
    choices: [
      { text: "Pray for guidance", nextScene: "prayer", tag: "faithful", feedback: "Peace settles in your chest.", isCorrect: true, sentiment: "positive" },
    ],
  },
  prayer: {
    id: "prayer",
  ...
  ignore_consequence: {
    ...
    choices: [
      { text: "Begin weaving a basket", nextScene: "weave_basket", tag: "faithful", feedback: "Your hands move with purpose.", isCorrect: true, sentiment: "positive" },
    ],
  },
  ...
  clay_consequence: {
    ...
    choices: [
      { text: "Coat it with pitch", nextScene: "miriam_called", tag: "wise", feedback: "The seams hold tight.", isCorrect: true, sentiment: "positive" },
    ],
  },
  miriam_called: {
    id: "miriam_called",
  ...
  anger_consequence: {
    ...
    choices: [
      { text: "Take her with you", nextScene: "to_river", tag: "wise", feedback: "She slips her hand into yours.", isCorrect: true, sentiment: "positive" },
    ],
  },
  lie_consequence: {
    id: "lie_consequence",
    ...
    choices: [
      { text: "Tell her the truth", nextScene: "to_river", tag: "wise", feedback: "Her chin lifts. She is ready.", isCorrect: true, sentiment: "positive" },
    ],
  },
  to_river: {
    id: "to_river",
  ...
  throw_consequence: {
    ...
    choices: [
      { text: "Place him gently in the reeds", nextScene: "place_basket", tag: "wise", feedback: "The basket bobs softly.", isCorrect: true, sentiment: "positive" },
    ],
  },
  place_basket: {
    id: "place_basket",
    ...
    choices: [
      { text: "Snatch him back and run home", nextScene: "snatch_consequence", tag: "fearful", feedback: "Faith means letting go.", isCorrect: false, sentiment: "negative" },
      { text: "Whisper a blessing and step back", nextScene: "miriam_watch", tag: "faithful", feedback: "\"The Lord keep you, my son.\"", isCorrect: true, sentiment: "positive" },
    ],
  },
  snatch_consequence: {
    ...
    choices: [
      { text: "Bless him and let him go", nextScene: "miriam_watch", tag: "faithful", feedback: "Tears fall on the reeds.", isCorrect: true, sentiment: "positive" },
    ],
  },
  ...
  swim_consequence: {
    ...
    choices: [
      { text: "Tell her to watch from the reeds", nextScene: "princess_arrives", tag: "wise", feedback: "She crouches, silent and still.", isCorrect: true, sentiment: "positive" },
    ],
  },
  princess_arrives: {
    id: "princess_arrives",
  ...
  stone_consequence: {
    ...
    choices: [
      { text: "Wait and trust God", nextScene: "she_sees", tag: "faithful", feedback: "The princess steps closer.", isCorrect: true, sentiment: "positive" },
    ],
  },
  she_sees: {
    id: "she_sees",
  ...
  shout_consequence: {
    ...
    choices: [
      { text: "Stay hidden and pray", nextScene: "she_opens", tag: "faithful", feedback: "The basket rises slowly.", isCorrect: true, sentiment: "positive" },
    ],
  },
  ...
  beg_consequence: {
    ...
    choices: [
      { text: "Pray quietly and watch", nextScene: "compassion", tag: "faithful", feedback: "She cradles the baby.", isCorrect: true, sentiment: "positive" },
    ],
  },
  compassion: {
    id: "compassion",
  ...
  silent_consequence: {
    ...
    choices: [
      { text: "Let Miriam approach the princess", nextScene: "miriam_offers", tag: "wise", feedback: "She rises from the reeds.", isCorrect: true, sentiment: "positive" },
    ],
  },
  miriam_offers: {
    id: "miriam_offers",
    ...
    choices: [
      { text: "Suggest an Egyptian wet nurse", nextScene: "egyptian_consequence", tag: "fearful", feedback: "He must come back to you.", isCorrect: false, sentiment: "negative" },
      { text: "Wait for the princess's answer", nextScene: "yes_go", tag: "faithful", feedback: "\"Go,\" she says.", isCorrect: true, sentiment: "positive" },
    ],
  },
  egyptian_consequence: {
    ...
    choices: [
      { text: "Wait for the princess to answer", nextScene: "yes_go", tag: "faithful", feedback: "\"Go and bring her,\" she says.", isCorrect: true, sentiment: "positive" },
    ],
  },
  ...
  refuse_consequence: {
    ...
    choices: [
      { text: "Go to the princess", nextScene: "before_princess", tag: "faithful", feedback: "Your sandals slap the path.", isCorrect: true, sentiment: "positive" },
    ],
  },
  before_princess: {
    id: "before_princess",
    ...
    choices: [
      { text: "Confess that you are his mother", nextScene: "confess_consequence", tag: "rash", feedback: "Silence now serves God's plan.", isCorrect: false, sentiment: "negative" },
      { text: "Accept the wages and the child", nextScene: "wages", tag: "wise", feedback: "\"Take him. Nurse him for me.\"", isCorrect: true, sentiment: "positive" },
    ],
  },
  confess_consequence: {
    ...
    choices: [
      { text: "Bow and accept the child", nextScene: "wages", tag: "wise", feedback: "She smiles, none the wiser.", isCorrect: true, sentiment: "positive" },
    ],
  },
  wages: {
    id: "wages",
  ...
  pride_consequence: {
    ...
    choices: [
      { text: "Take him home", nextScene: "home_again", tag: "faithful", feedback: "You walk home weeping with joy.", isCorrect: true, sentiment: "positive" },
    ],
  },
  home_again: {
    id: "home_again",
  ...
  hide_forever_consequence: {
    ...
    choices: [
      { text: "Prepare him for the palace", nextScene: "return_palace", tag: "faithful", feedback: "You braid his hair with prayers.", isCorrect: true, sentiment: "positive" },
    ],
  },
  return_palace: {
    id: "return_palace",
  ...
  runaway_consequence: {
    ...
    choices: [
      { text: "Place him in her arms", nextScene: "named_moses", tag: "faithful", feedback: "Her eyes shine with love.", isCorrect: true, sentiment: "positive" },
    ],
  },
  named_moses: {
    id: "named_moses",
    ...
    choices: [
      { text: "Walk away in faith", nextScene: "ending", tag: "faithful", feedback: "God's plan has only begun.", isCorrect: true, sentiment: "positive" },
    ],
  },
  ending: {
    id: "ending",

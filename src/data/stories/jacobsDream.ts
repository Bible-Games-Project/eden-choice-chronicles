...
export const jacobsDreamScenes: Record<string, StoryScene> = {
  ...
  turn_back_consequence: {
    ...
    choices: [
      { text: "Turn east again — keep walking", nextScene: "wilderness", tag: "obedient", feedback: "You set your face toward Haran once more.", isCorrect: true, sentiment: "positive" },
    ],
  },
  hide_consequence: {
    id: "hide_consequence",
    ...
    choices: [
      { text: "Step out and walk on", nextScene: "wilderness", tag: "obedient", feedback: "You leave the shadows. The journey is yours.", isCorrect: true, sentiment: "positive" },
    ],
  },
  wilderness: {
    id: "wilderness",
  ...
  push_on_consequence: {
    ...
    choices: [
      { text: "Stop and rest at the stony place", nextScene: "the_place", tag: "trusting", feedback: "The Lord's place was waiting all along.", isCorrect: true, sentiment: "positive" },
    ],
  },
  ...
  soft_consequence: {
    ...
    choices: [
      { text: "Place a stone beneath your head", nextScene: "lay_down", tag: "humble", feedback: "Hardness becomes rest. You close your eyes.", isCorrect: true, sentiment: "positive" },
    ],
  },
  wander_consequence: {
    ...
    choices: [
      { text: "Take a stone for a pillow", nextScene: "lay_down", tag: "humble", feedback: "You set a stone for your head and lie down.", isCorrect: true, sentiment: "positive" },
    ],
  },
  lay_down: {
    id: "lay_down",
    ...
    choices: [
      { text: "Close your eyes and sleep", nextScene: "the_dream", tag: "resting", feedback: "Sleep takes you. And then — light.", isCorrect: true, sentiment: "positive" },
    ],
  },
  ...
  climb_consequence: {
    ...
    choices: [
      { text: "Stand still and watch", nextScene: "the_voice", tag: "reverent", feedback: "You bow your head. Light fills your eyes.", isCorrect: true, sentiment: "positive" },
    ],
  },
  call_consequence: {
    id: "call_consequence",
    ...
    choices: [
      { text: "Be silent and listen", nextScene: "the_voice", tag: "reverent", feedback: "You fall quiet. Then He speaks.", isCorrect: true, sentiment: "positive" },
    ],
  },
  the_voice: {
    id: "the_voice",
  ...
  bargain_consequence: {
    ...
    choices: [
      { text: "Receive the promise", nextScene: "the_promise", tag: "receiving", feedback: "Your heart bows. The promise rests upon you.", isCorrect: true, sentiment: "positive" },
    ],
  },
  the_promise: {
    id: "the_promise",
    ...
    choices: [
      { text: "Treasure His words in your heart", nextScene: "awakening", tag: "treasuring", feedback: "The vision fades. The stars return. Dawn is near.", isCorrect: true, sentiment: "positive" },
    ],
  },
  ...
  awakening: {
    ...
    choices: [
      { text: "Call this place the house of God", nextScene: "set_pillar", tag: "naming", feedback: "\"This is none other than Bethel — the gate of heaven.\"", isCorrect: true, sentiment: "positive" },
      { text: "Hurry away before the vision returns", nextScene: "flee_consequence", tag: "fearful", feedback: "Fear is not faith. The place asks something of you.", isCorrect: false, sentiment: "negative" },
      { text: "Tell no one — keep it secret", nextScene: "secret_consequence", tag: "hiding", feedback: "Some things are sealed by remembrance, not silence.", isCorrect: false, sentiment: "negative" },
    ],
  },
  flee_consequence: {
    id: "flee_consequence",
    ...
    choices: [
      { text: "Return and set up the stone", nextScene: "set_pillar", tag: "naming", feedback: "You walk back. The stone is waiting.", isCorrect: true, sentiment: "positive" },
    ],
  },
  secret_consequence: {
    ...
    choices: [
      { text: "Set up the stone as a pillar", nextScene: "set_pillar", tag: "naming", feedback: "You lift the stone. It will stand as witness.", isCorrect: true, sentiment: "positive" },
    ],
  },
  set_pillar: {
    id: "set_pillar",
  ...
  plain_consequence: {
    ...
    choices: [
      { text: "Anoint the stone with oil", nextScene: "anoint", tag: "consecrating", feedback: "You pour the oil. It is the Lord's portion.", isCorrect: true, sentiment: "positive" },
    ],
  },
  anoint: {
    id: "anoint",
    ...
    choices: [
      { text: "Vow a tenth of all He gives you", nextScene: "the_vow", tag: "vowing", feedback: "\"Of all You give me, I will surely give a tenth to You.\"", isCorrect: true, sentiment: "positive" },
      { text: "Promise nothing — just receive", nextScene: "withhold_consequence", tag: "withholding", feedback: "Grace welcomes a vow in return. Words become a covenant.", isCorrect: false, sentiment: "negative" },
    ],
  },
  withhold_consequence: {
    ...
    choices: [
      { text: "Vow a tenth of all to the LORD", nextScene: "the_vow", tag: "vowing", feedback: "\"Of all You give me, I will give a tenth to You.\"", isCorrect: true, sentiment: "positive" },
    ],
  },
  the_vow: {
    id: "the_vow",
    ...
    choices: [
      { text: "Walk on with the LORD", nextScene: "journey_on", tag: "trusting", feedback: "Each step is lighter than the last. The promise walks with you.", isCorrect: true, sentiment: "positive" },
    ],
    isFinal: false,
  },
  journey_on: {

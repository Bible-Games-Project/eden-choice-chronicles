...
export const samuelCalledScenes: Record<string, StoryScene> = {
  ...
  start: {
    ...
    choices: [
      ...
      { text: "Tend the lamp with care", nextScene: "night_falls", tag: "faithful", feedback: "The flame steadies in your hand.", isCorrect: true, sentiment: "positive" },
  ...
  night_falls: {
    ...
    choices: [
      { text: "Run to Eli to answer him", nextScene: "second_call", tag: "obedient", feedback: "You hurry through the dim hall.", isCorrect: true, sentiment: "positive" },
  ...
  second_call: {
    ...
    choices: [
      ...
      { text: "Go to Eli once more", nextScene: "third_call", tag: "obedient", feedback: "Faithful steps in the dark.", isCorrect: true, sentiment: "positive" },
    ],
  },
  doubt_consequence: {
  ...
  third_call: {
    ...
    choices: [
      ...
      { text: "Go back and wait to listen", nextScene: "respond_god", tag: "humble", feedback: "Eli's hand rests on your shoulder.", isCorrect: true, sentiment: "positive" },
  ...
  respond_god: {
    ...
    choices: [
      ...
      { text: "\"Speak, Lord. I am listening.\"", nextScene: "prophet_calling", tag: "surrendered", feedback: "The room fills with quiet light.", isCorrect: true, sentiment: "positive" },
    ],
  },
  hide_consequence: {
    id: "hide_consequence",

...
export const adamEveScenes: Record<string, StoryScene> = {
  start: {
    ...
    choices: [
      ...
      { text: "Follow the sound of water", nextScene: "river", tag: "explorer", feedback: "The current calls you forward — cool, inviting.", sentiment: "neutral" },
      { text: "Be still. Just breathe.", nextScene: "meditation", tag: "contemplative", feedback: "You inhale. The whole garden breathes with you.", sentiment: "neutral" },
    ],
  },
  animals: {
    id: "animals",
    ...
    choices: [
      ...
      { text: "Walk deeper into the garden", nextScene: "flowers", tag: "wanderer", feedback: "Something pulls you inward — past the trees, past the light.", sentiment: "neutral" },
    ],
  },
  river: {
    id: "river",
    ...
    choices: [
      ...
      { text: "Follow the river upstream", nextScene: "upstream", tag: "seeker", feedback: "The current resists — but something glows ahead.", sentiment: "neutral" },
      { text: "Rest and listen", nextScene: "meditation_river", tag: "peaceful", feedback: "You sit. The river whispers secrets you almost understand.", sentiment: "neutral" },
    ],
  },
  meditation: {
    id: "meditation",
    ...
    choices: [
      ...
      { text: "Wander toward the flowers", nextScene: "flowers", tag: "inspired", feedback: "Color catches your eye — impossible, beautiful.", sentiment: "neutral" },
      { text: "Go deeper into the garden", nextScene: "deep_garden", tag: "bold", feedback: "Your feet move on their own. The center pulls.", sentiment: "neutral" },
    ],
  },
  naming: {
    id: "naming",
    ...
    choices: [
      ...
      { text: "Sit among the flowers", nextScene: "flowers", tag: "reflective", feedback: "You sit — surrounded by beauty, touched by sadness.", sentiment: "neutral" },
    ],
  },
  play: {
    id: "play",
    ...
    choices: [
      { text: "Chase a butterfly deeper", nextScene: "deep_garden", tag: "carefree", feedback: "Wings flash gold. You follow without thinking.", sentiment: "positive" },
      { text: "Follow the scent of flowers", nextScene: "flowers", tag: "drawn", feedback: "Sweetness drifts toward you — heady, magnetic.", sentiment: "neutral" },
    ],
  },
  flowers: {
    id: "flowers",
    ...
    choices: [
      { text: "Weave a garland", nextScene: "garland", tag: "tender", feedback: "Your fingers work gently — who will wear it?", sentiment: "neutral" },
      { text: "Follow the path", nextScene: "approach_tree", tag: "curious_path", feedback: "The trees lean close. The air grows thick.", sentiment: "neutral" },
  ...
  upstream: {
    ...
    choices: [
      { text: "Descend toward the center", nextScene: "approach_tree", tag: "drawn_center", feedback: "The garden's heart beats below. You feel it.", sentiment: "neutral" },
      { text: "Return to the flowers", nextScene: "flowers", tag: "returning", feedback: "You turn back. The flowers wait — patient, perfect.", sentiment: "neutral" },
    ],
  },
  meditation_river: {
    id: "meditation_river",
    ...
    choices: [
      { text: "Answer the call", nextScene: "deep_garden", tag: "called", feedback: "You stand. The pull is undeniable now.", sentiment: "positive" },
      { text: "Visit the animals", nextScene: "animals", tag: "caring", feedback: "You rise — they need you. Or you need them.", sentiment: "neutral" },
    ],
  },
  deep_garden: {
    id: "deep_garden",
    ...
    choices: [
      ...
      { text: "Rest beneath a fig tree", nextScene: "fig_rest", tag: "cautious", feedback: "You sit in the shade. Eyes watch from the branches.", sentiment: "neutral" },
    ],
  },
  garland: {
    id: "garland",
    ...
    choices: [
      { text: "Walk toward the center", nextScene: "deep_garden", tag: "yearning", feedback: "The ache rises — beautiful and unbearable.", sentiment: "neutral" },
      { text: "Keep exploring", nextScene: "upstream", tag: "restless", feedback: "Movement helps. You press onward.", sentiment: "neutral" },
    ],
  },
  sky_gaze: {
    id: "sky_gaze",
    ...
    choices: [
      { text: "Follow the pull toward the center", nextScene: "deep_garden", tag: "destined", feedback: "Something waits for you. It has always waited.", sentiment: "positive" },
  ...
  fig_rest: {
    ...
    choices: [
      { text: "Ignore it", nextScene: "sleep", tag: "wary", feedback: "You close your eyes. But the gaze lingers.", sentiment: "neutral" },
  ...
  paradise_together: {
    ...
    choices: [
      ...
      { text: "Wander toward the center", nextScene: "approach_tree_together", tag: "curious_together", feedback: "You walk deeper. She follows, trusting.", sentiment: "neutral" },
    ],
  },
  eden_walk: {
    id: "eden_walk",
    ...
    choices: [
      { text: "Explore further together", nextScene: "approach_tree_together", tag: "bonded", feedback: "Hand in hand, you press deeper into the garden.", sentiment: "neutral" },
      { text: "Stay here — this is enough", nextScene: "approach_tree_together", tag: "content", feedback: "But the garden is vast. And curiosity is older than fear.", sentiment: "neutral" },
    ],
  },
  ...
  serpent_speaks: {
    ...
    choices: [
      ...
      { text: "Defend what God said", nextScene: "temptation", tag: "defending", feedback: "Your words sound right. But something in you wavers.", sentiment: "neutral" },
  ...
  hiding: {
    ...
    choices: [
      { text: "\"I was afraid… I was naked\"", nextScene: "judgment", tag: "confessing", feedback: "The words fall from you — broken, honest.", sentiment: "neutral" },
  ...
  judgment: {
    ...
    choices: [
      ...
      { text: "Say nothing — bow your head", nextScene: "expulsion", tag: "silent", feedback: "Words fail. You lower your eyes.", sentiment: "neutral" },
    ],
  },
  expulsion: {
    id: "expulsion",

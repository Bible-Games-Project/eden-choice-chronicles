...
export const deborahBarakScenes: Record<string, StoryScene> = {
  ...
  start: {
    ...
    choices: [
      ...
      { text: "Listen and judge with His wisdom", nextScene: "call_barak", tag: "faithful", feedback: "Judges 4:5 — Deborah held court under the Palm of Deborah, and the Israelites came to her to have their disputes decided.", isCorrect: true, sentiment: "positive" },
  ...
  call_barak: {
    ...
    choices: [
      ...
      { text: "Summon Barak to receive the word", nextScene: "barak_arrives", tag: "obedient", feedback: "Judges 4:6 — Deborah sent for Barak and told him that the Lord commanded him to lead an army to Mount Tabor.", isCorrect: true, sentiment: "positive" },
    ],
  },
  lead_consequence: {
    id: "lead_consequence",
  ...
  barak_arrives: {
    ...
    choices: [
      ...
      { text: "Agree to go with him", nextScene: "march_to_tabor", tag: "courageous", feedback: "Judges 4:9 — Deborah told Barak that she would indeed go with him to battle Sisera.", isCorrect: true, sentiment: "positive" },
    ],
  },
  refuse_consequence: {
  ...
  march_to_tabor: {
    ...
    choices: [
      ...
      { text: "Declare the Lord goes before you", nextScene: "battle_kishon", tag: "faithful", feedback: "Judges 4:14 — Deborah told Barak to go, for the Lord had gone ahead of him.", isCorrect: true, sentiment: "positive" },
    ],
  },
  wait_consequence: {
    id: "wait_consequence",
  ...
  battle_kishon: {
    ...
    choices: [
      ...
      { text: "Charge in the strength He gives", nextScene: "victory", tag: "courageous", feedback: "Judges 4:14 — Deborah told Barak that the Lord had given Sisera into his hands.", isCorrect: true, sentiment: "positive" },
  ...
  victory: {
    ...
    choices: [
      ...
      { text: "Sing praise to the Lord", nextScene: "ending_faithful", tag: "humble", feedback: "Judges 5:1 — Deborah and Barak sang a song of praise on that day.", isCorrect: true, sentiment: "positive" },
    ],
  },
  credit_consequence: {

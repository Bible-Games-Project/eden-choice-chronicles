...
export const tenVirginsScenes: Record<string, StoryScene> = {
  ...
  start: {
    ...
    choices: [
      { text: "Lean in and listen close", nextScene: "wait", tag: "faithful", feedback: "His words settle in you.", isCorrect: true, sentiment: "positive" },
  ...
  wait: {
    ...
    choices: [
      { text: "Stand with them and wait", nextScene: "oil", tag: "faithful", feedback: "You join the watch.", isCorrect: true, sentiment: "positive" },
  ...
  oil: {
    ...
    choices: [
      ...
      { text: "Fill a flask with extra oil", nextScene: "delay", tag: "faithful", feedback: "Wisdom prepares.", isCorrect: true, sentiment: "positive" },
  ...
  delay: {
    ...
    choices: [
      ...
      { text: "Keep watch through the night", nextScene: "midnight", tag: "faithful", feedback: "Patience holds you steady.", isCorrect: true, sentiment: "positive" },
    ],
  },
  curse_consequence: {
  ...
  midnight: {
    ...
    choices: [
      { text: "Trim your lamp and rise", nextScene: "run", tag: "faithful", feedback: "Your flame steadies.", isCorrect: true, sentiment: "positive" },
  ...
  run: {
    ...
    choices: [
      ...
      { text: "Walk on with the wise five", nextScene: "door", tag: "faithful", feedback: "You move toward the light.", isCorrect: true, sentiment: "positive" },
    ],
  },
  mock_consequence: {
    id: "mock_consequence",
  ...
  door: {
    ...
    choices: [
      ...
      { text: "Stand in the warm light within", nextScene: "ending", tag: "faithful", feedback: "You are home in time.", isCorrect: true, sentiment: "positive" },
    ],
  },
  demand_consequence: {

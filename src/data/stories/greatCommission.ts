...
export const greatCommissionScenes: Record<string, StoryScene> = {
  ...
  start: {
    ...
    choices: [
      ...
      { text: "Climb with hope to meet Him", nextScene: "worship", tag: "humble", feedback: "Your steps grow lighter.", isCorrect: true, sentiment: "positive" },
    ],
  },
  linger_consequence: {
  ...
  worship: {
    ...
    choices: [
      ...
      { text: "Bow low. Worship the Lord", nextScene: "authority", tag: "humble", feedback: "Your knees touch the grass.", isCorrect: true, sentiment: "positive" },
  ...
  authority: {
    ...
    choices: [
      ...
      { text: "Receive His word in awe", nextScene: "go_nations", tag: "humble", feedback: "Heaven and earth are His.", isCorrect: true, sentiment: "positive" },
    ],
  },
  argue_consequence: {
  ...
  go_nations: {
    ...
    choices: [
      ...
      { text: "Say yes. Go to every nation", nextScene: "baptize", tag: "merciful", feedback: "Your heart widens to the world.", isCorrect: true, sentiment: "positive" },
    ],
  },
  israel_consequence: {
  ...
  baptize: {
    ...
    choices: [
      ...
      { text: "Baptize all who believe in Him", nextScene: "teach", tag: "merciful", feedback: "Water becomes the door.", isCorrect: true, sentiment: "positive" },
  ...
  teach: {
    ...
    choices: [
      ...
      { text: "Teach all He has commanded", nextScene: "presence", tag: "humble", feedback: "His words become your road.", isCorrect: true, sentiment: "positive" },
    ],
  },
  easy_consequence: {
    id: "easy_consequence",
  ...
  presence: {
    ...
    choices: [
      ...
      { text: "Trust His Spirit goes with you", nextScene: "ending", tag: "humble", feedback: "Peace fills your chest.", isCorrect: true, sentiment: "positive" },

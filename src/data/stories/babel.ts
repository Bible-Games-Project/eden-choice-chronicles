...
export const babelScenes: Record<string, StoryScene> = {
  start: {
    ...
    choices: [
      ...
      { text: "Dream of something greater", nextScene: "unity", tag: "ambitious", feedback: "Genesis 11:2 — The people settled in the plain of Shinar and dreamed of greatness.", isCorrect: true, sentiment: "negative" },
    ],
  },
  unity: {
    id: "unity",
    ...
    choices: [
      ...
      { text: "Boast of what we could achieve", nextScene: "proposal", tag: "boastful", feedback: "Genesis 11:4 — They said, 'Let us make a name for ourselves.'", isCorrect: true, sentiment: "negative" },
  ...
  proposal: {
    ...
    choices: [
      { text: "Cheer — join the great work", nextScene: "bricks", tag: "eager", feedback: "Genesis 11:3-4 — The people joined together to build a city and a great tower.", isCorrect: true, sentiment: "negative" },
  ...
  bricks: {
    ...
    choices: [
      { text: "Work for the love of craft", nextScene: "construction", tag: "honest", feedback: "Genesis 11:3 — They made bricks and used tar for mortar to build the tower.", isCorrect: true, sentiment: "positive" },
  ...
  construction: {
    ...
    choices: [
      { text: "Boast — \"We need no God now\"", nextScene: "rising", tag: "blasphemous", feedback: "Genesis 11:4 — They boasted, seeking a tower with its top reaching the heavens.", isCorrect: true, sentiment: "negative" },
  ...
  rising: {
    ...
    choices: [
      ...
      { text: "Climb higher — there is no limit", nextScene: "summit", tag: "ambitious", feedback: "Genesis 11:4-5 — The tower rose higher in pride until the Lord came down to see it.", isCorrect: true, sentiment: "negative" },
  ...
  summit: {
    ...
    choices: [
      { text: "Reach upward — claim the sky", nextScene: "gods_gaze", tag: "prideful", feedback: "Genesis 11:4 — Their pride reached upward, seeking to make a name for themselves.", isCorrect: true, sentiment: "negative" },
  ...
  gods_gaze: {
    ...
    choices: [
      { text: "Stand defiant before the voice", nextScene: "confusion", tag: "defiant", feedback: "Genesis 11:6-7 — God saw their pride and chose to confuse their language.", isCorrect: true, sentiment: "negative" },
  ...
  confusion: {
    ...
    choices: [
      ...
      { text: "Step back — accept what God has done", nextScene: "scattering", tag: "accepting", feedback: "Genesis 11:7 — God confused their language so they could not understand one another.", isCorrect: true, sentiment: "positive" },
  ...
  scattering: {
    ...
    choices: [
      ...
      { text: "Walk in silence, lesson in heart", nextScene: "reflection", tag: "humble", feedback: "Genesis 11:8 — The Lord scattered the people from there over all the earth.", isCorrect: true, sentiment: "positive" },
    ],
  },
  reflection: {
    id: "reflection",

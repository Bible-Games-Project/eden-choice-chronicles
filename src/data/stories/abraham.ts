...
export const abrahamScenes: Record<string, StoryScene> = {
  start: {
    ...
    choices: [
      { text: "Walk through the marketplace", nextScene: "familiar_life", tag: "routine", feedback: "The same faces. The same roads. The same gods of stone.", sentiment: "negative" },
      ...
      { text: "Tend to your flocks outside the walls", nextScene: "familiar_life", tag: "dutiful", feedback: "The sheep follow you without question. You envy them.", sentiment: "negative" },
    ],
  },
  familiar_life: {
    id: "familiar_life",
    ...
    choices: [
      { text: "Accept what you have", nextScene: "restlessness", tag: "resigned", feedback: "You try. But the emptiness returns every night.", sentiment: "negative" },
  ...
  the_voice: {
    ...
    choices: [
      ...
      { text: "\"Who speaks?\"", nextScene: "the_promise", tag: "questioning", feedback: "No answer — only the weight of presence. Undeniable.", sentiment: "negative" },
  ...
  the_promise: {
    ...
    choices: [
      { text: "\"But I have no son…\"", nextScene: "the_weight", tag: "doubting", feedback: "The promise feels impossible. A nation — from you?", sentiment: "negative" },
  ...
  the_weight: {
    ...
    choices: [
      { text: "Think of Sarai — what will she say?", nextScene: "telling_sarai", tag: "devoted", feedback: "She has followed you through everything. But this…", sentiment: "negative" },
  ...
  telling_sarai: {
    ...
    choices: [
      ...
      { text: "\"I… I don't know how to explain.\"", nextScene: "sarai_responds", tag: "struggling", feedback: "She waits. Patient. She has always been patient.", sentiment: "negative" },
  ...
  sarai_responds: {
    ...
    choices: [
      ...
      { text: "\"You would leave everything?\"", nextScene: "the_decision", tag: "amazed", feedback: "\"I would leave everything for the truth,\" she says.", sentiment: "negative" },
    ],
  },
  the_horizon: {
    id: "the_horizon",
  ...
  the_struggle: {
    ...
    choices: [
      ...
      { text: "Pray through the darkness", nextScene: "the_decision", tag: "surrendering", feedback: "No words. Just breath. And slowly — peace.", sentiment: "positive" },
    ],
  },
  the_decision: {
    id: "the_decision",
    ...
    choices: [
      ...
      { text: "Look back one last time", nextScene: "the_road", tag: "torn", feedback: "The rooftops shimmer in morning light. Goodbye.", sentiment: "negative" },
  ...
  the_road: {
    ...
    choices: [
      ...
      { text: "Walk in silence with Sarai", nextScene: "the_stars", tag: "together", feedback: "No words needed. Her presence is enough.", sentiment: "positive" },
    ],
  },
  the_stars: {
    id: "the_stars",
    ...
    choices: [
      ...
      { text: "Weep — from exhaustion and wonder", nextScene: "arrival", tag: "overwhelmed", feedback: "The tears fall into the dust. The stars hold you.", sentiment: "negative" },

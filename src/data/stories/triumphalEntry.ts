...
export const triumphalEntryScenes: Record<string, StoryScene> = {
  ...
  start: {
    ...
    choices: [
      ...
      { text: "Walk quietly beside him", nextScene: "donkey", tag: "faithful", feedback: "You match his peace.", isCorrect: true, sentiment: "positive" },
  ...
  donkey: {
    ...
    choices: [
      ...
      { text: "Lay your cloak on its back", nextScene: "ride", tag: "faithful", feedback: "You give what is yours.", isCorrect: true, sentiment: "positive" },
    ],
  },
  horse_consequence: {
  ...
  ride: {
    ...
    choices: [
      ...
      { text: "Recognize the word fulfilled", nextScene: "cloaks", tag: "faithful", feedback: "Your heart leaps.", isCorrect: true, sentiment: "positive" },
  ...
  cloaks: {
    ...
    choices: [
      ...
      { text: "Lay your cloak on the road", nextScene: "palms", tag: "faithful", feedback: "You give it gladly.", isCorrect: true, sentiment: "positive" },
    ],
  },
  keep_consequence: {
    id: "keep_consequence",
  ...
  palms: {
    ...
    choices: [
      ...
      { text: "Wave a branch with joy", nextScene: "hosanna", tag: "faithful", feedback: "Your branch dances.", isCorrect: true, sentiment: "positive" },
  ...
  hosanna: {
    ...
    choices: [
      ...
      { text: "Sing Hosanna with the crowd", nextScene: "pharisees", tag: "faithful", feedback: "Your voice joins theirs.", isCorrect: true, sentiment: "positive" },
    ],
  },
  ...
  pharisees: {
    ...
    choices: [
      ...
      { text: "Trust him — \"Even stones would cry.\"", nextScene: "enter", tag: "faithful", feedback: "You stand firm in praise.", isCorrect: true, sentiment: "positive" },
  ...
  enter: {
    ...
    choices: [
      ...
      { text: "Follow him into the city", nextScene: "ending", tag: "faithful", feedback: "You walk with the King.", isCorrect: true, sentiment: "positive" },
    ],
  },
  slip_consequence: {
    id: "slip_consequence",
